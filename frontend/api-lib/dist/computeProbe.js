...
exports.computeModelId = computeModelId;
exports.computeCapability = computeCapability;
exports.probeCompute = probeCompute;
exports.computeEnv = computeEnv;
function vercelCap(requested, cap) {
...
function computeEnv() {
    ...
    return {
        ...
        timeoutMs: vercelCap(requested, 9_500),
    };
}
...
function computeCapability() {
    ...
    if (!apiKey) {
        return {
            available: false,
            blockedReason: 'ZG_COMPUTE_API_KEY is not set. Create an inference key at https://pc.0g.ai and fund the unified balance with 0G.',
        };
    }
    if (!model) {
        return {
            available: false,
            blockedReason: 'ZG_COMPUTE_MODEL is not set. Pick a model id from GET https://router-api.0g.ai/v1/models.',
        };
    }
